...
// Windows opens the Start menu when the Win key is released without any other
// key having been pressed in between. Mouse clicks don't count, so press a
// key nobody uses (VK 0xE8 is unassigned) to mark the Win key as "used".
void MaskWinKeyRelease() {
